...
| asyncPolling                                                           | optional | **Deprecated.** Same as `async-polling`; still accepted for backward compatibility. Do not set both keys in the same DDL. Use `async-polling` for new configurations.                                                                                                                                                                                                                                    |
